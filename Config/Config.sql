...
VALUES  ('LEADER_TRIPLE_T_DSH_NAME', 'Unique', 'COLOR_PLAYER_WHITE_TEXT', 'COLOR_PLAYER_BLACK_BACKGROUND', 'COLOR_PLAYER_WHITE_TEXT');
...
VALUES  ('Players:Expansion2_Players', 'CIVILIZATION_BRAINROT_DSH_NAME', 'LEADER_TRIPLE_T_DSH_NAME', 'UNIT_SWORDSMAN', 'ICON_UNIT_SWORDSMAN', 'LOC_UNIT_SWORDSMAN_NAME', 'LOC_UNIT_SWORDSMAN_DESCRIPTION', 10),
        ('Players:Expansion2_Players', 'CIVILIZATION_BRAINROT_DSH_NAME', 'LEADER_TRIPLE_T_DSH_NAME', 'BUILDING_MONUMENT', 'ICON_BUILDING_MONUMENT', 'LOC_BUILDING_MONUMENT_NAME', 'LOC_BUILDING_MONUMENT_DESCRIPTION', 20);